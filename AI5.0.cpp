...
int Escape[MAXLEN][MAXLEN]={\
         ...
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,UP,NOP,NOP,NOP,UP,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,UP,LEFT,LEFT,LEFT,UP,NOP,DOWN,RIGHT,NOP,LEFT,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,UP,LEFT,LEFT,LEFT,UP,LEFT,UP,RIGHT,NOP,UP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,RIGHT,RIGHT,UP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,DOWN,RIGHT,DOWN,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,DOWN,LEFT,LEFT,LEFT,DOWN,LEFT,DOWN,DOWN,NOP,DOWN,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,DOWN,LEFT,LEFT,LEFT,DOWN,NOP,UP,RIGHT,NOP,LEFT,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,DOWN,NOP,NOP,NOP,DOWN,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,
         NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,NOP,
...
void BulidSafeMap()
{
    for(int i=1;i<=BombNum;i++)
    {
        ...
        if(BombTime[i]>2)
            continue;
        SafeMap[Y][X]=ATTENTION;
        for(int i=0;i<4;i++)
            for(int j=1;j<=2;j++)
            {
                int TX=X+Dir[i][1]*j;
                int TY=Y+Dir[i][0]*j;
                if(SourceMap[TY][TX]!=BLANK)
                    break;
                SafeMap[TY][TX]=ATTENTION;
            }
    }
}
...
bool FindBomb(int X,int Y)
{
  for(int i=1;i<=BombNum;i++)
  {
      if(BombX[i]==X&&BombY[i]==Y&&((BombHost[i]==MyGroupID)||(BombHost[i]==GROUP_NEUTRAL)))
        return true;
  }
  return false;
}
...
int GetCorrectOp(int ID)
{
    ...
    for(int i=1;i<=4;i++)
        if(IsOpOK(i,MapOp))
        {
            ...
            if(SourceMap[Next.y][Next.x]==BLANK&&SafeMap[Next.y][Next.x]==0)
                return i;
        }
    return NOP;
}
int GetAOp()
{
    ...
    if(FindBomb(10,10)||FindBomb(15,10)||FindBomb(13,9))
        return Escape[Pos.y][Pos.x];
    if(Pos.x==15&&Pos.y==10)
        return PUT;
    if(SourceMap[10][11]==WOOD&&IsAtPos(Pos,10,10))
        return PUT;
    if(SourceMap[9][15]==WOOD&&IsAtPos(Pos,13,9))
        return PUT;
    if(SafeMap[Pos.y][Pos.x]==ATTENTION)
        return Escape[Pos.y][Pos.x];
...
int GetBOp()
{
    ...
    if(IsAtPos(PosA,15,10)&&IsAtPos(PosB,15,6)&&(!FindBomb(15,10)))
        return NOP;
    if(FindBomb(10,6)||FindBomb(15,6)||FindBomb(13,7))
        return Escape[PosB.y][PosB.x];
    if(PosB.x==15&&PosB.y==6)
        return PUT;
    if(SourceMap[6][11]==WOOD&&IsAtPos(PosB,10,6))
        return PUT;
    if(SourceMap[7][15]==WOOD&&IsAtPos(PosB,13,7))
        return PUT;
    if(SafeMap[PosB.y][PosB.x]==ATTENTION)
        return Escape[PosB.y][PosB.x];
